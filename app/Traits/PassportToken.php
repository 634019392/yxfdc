...
trait PassportToken
{
    ...
    protected function createPassportTokenByUser(Apiuser $apiuser, $clientId)
    {
        $accessToken = new AccessToken($apiuser->id);
    ...
    protected function getBearerTokenByUser(Apiuser $apiuser, $clientId, $output = true)
    {
        $passportToken = $this->createPassportTokenByUser($apiuser, $clientId);
